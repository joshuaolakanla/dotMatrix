...
//MD_Parola P1 = MD_Parola(HARDWARE_TYPE, DATA_PIN2, CLK_PIN2, CS_PIN2, 16);
...
void display(){
  ...
  P.displayZoneText(2, bOut, PA_CENTER, 30, 30000, PA_PRINT, PA_PRINT);
  P.displayZoneText(3, bOut, PA_CENTER, 30, 30000, PA_PRINT, PA_PRINT);
  P.displayZoneText(4, cOut, PA_CENTER, 30, 30000, PA_PRINT, PA_PRINT);
  P.displayZoneText(5, cOut, PA_CENTER, 30, 30000, PA_PRINT, PA_PRINT);
  P.displayZoneText(6, dOut, PA_CENTER, 30, 30000, PA_PRINT, PA_PRINT);
  P.displayZoneText(7, dOut, PA_CENTER, 30, 30000, PA_PRINT, PA_PRINT);
  P.displayZoneText(8, aOut, PA_CENTER, 30, 30000, PA_PRINT, PA_PRINT);
  P.displayZoneText(9, aOut, PA_CENTER, 30, 30000, PA_PRINT, PA_PRINT);
  P.displayZoneText(10, aOut, PA_CENTER, 30, 30000, PA_PRINT, PA_PRINT);
  P.displayZoneText(11, aOut, PA_CENTER, 30, 30000, PA_PRINT, PA_PRINT); 
